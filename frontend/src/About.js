  ...
  return (
    <Container>
      <Card className="shadow-lg p-3 mb-5 bg-white rounded text-center" style={{ width: 'auto' }}>
        ...
        <Card.Text>
          <p>There is a subreddit called <a href="https://www.reddit.com/r/WritingPrompts/">Writing Prompts</a>, where millions of writers and wanna-be writers contribute to create new content. Crypto Prompts is the implementation of that content creation dynamic in the Polygon Blockchain. Here, Prompts are ERC-721 Non-Fungible Tokens that can be sold, auctioned or used as Prompts for new Prompts (Branches). Notice that every Branch is a Prompt, but initial Prompts are not Branches. Furthermore, Roots are Prompts with at least one Branch.</p>
        </Card.Text>
        </Card.Body>
      </Card>
      <Card className="shadow-lg p-3 mb-5 bg-white rounded text-center" style={{ width: 'auto' }}>
